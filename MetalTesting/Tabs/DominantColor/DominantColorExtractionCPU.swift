//
//  DominantColorExtractionCPU.swift
//  MetalTesting
//
...
class DominantColorExtraction {
    ...
    private static func adjustBrightness(red: CGFloat, green: CGFloat, blue: CGFloat, alpha: CGFloat) -> NSColor {
        var adjustedRed = red
